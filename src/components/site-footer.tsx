...
export function SiteFooter() {
  return <footer className="site-footer"><div className="footer-grid">
    ...
    <div><b>支持</b><Link href="/coaches">找 AI 陪练</Link><Link href="/become-coach">申请成为陪练</Link><Link href="/community">AI 实践社群</Link><Link href="/about">关于我们</Link><Link href="/privacy">隐私说明</Link></div>
